...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/Coderxopbolte/EAGLEyukkiop",
)
...
SUPPORT_CHANNEL = getenv(
    "SUPPORT_CHANNEL", "https://t.me/VICK_NETWORK"
)  # Example:- https://t.me/ArmanCardar
SUPPORT_GROUP = getenv(
    "SUPPORT_GROUP", "https://t.me/VICK_SUPPORT"
)  # Example:- https://t.me/ArmanWorldChat
...
START_IMG_URL = getenv(
    "START_IMG_URL",
    "https://files.catbox.moe/5its0o.jpg",  # This is the file id of the photo you can also put the url of photo
)
...
STREAM_IMG_URL = getenv(
    "STREAM_IMG_URL",
    "https://files.catbox.moe/li38li.jpg",
)
...
if STATS_IMG_URL:
    if STATS_IMG_URL != "https://files.catbox.moe/li38li.jpg":
...
if STREAM_IMG_URL:
    if STREAM_IMG_URL != "https://files.catbox.moe/0d3zjd.jpg":
